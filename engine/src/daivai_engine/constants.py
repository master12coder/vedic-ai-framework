...
SHATABDIKA_SEQUENCE: list[tuple[str, int]] = [
    ("Sun", 20), ("Moon", 20), ("Jupiter", 20), ("Mars", 20), ("Saturn", 20),
]
...
DWADASHOTTARI_SEQUENCE: list[tuple[str, int]] = [
    ("Sun", 7), ("Moon", 14), ("Mars", 8), ("Mercury", 17),
    ("Jupiter", 10), ("Venus", 25), ("Saturn", 10), ("Rahu", 21),
]
...
PANCHOTTARI_SEQUENCE: list[tuple[str, int]] = [
    ("Sun", 12), ("Moon", 21), ("Mars", 16), ("Mercury", 42), ("Saturn", 14),
]
...
SHATRIMSHA_SEQUENCE: list[tuple[str, int]] = [
    ("Sun", 6), ("Moon", 6), ("Venus", 6),
    ("Mercury", 6), ("Saturn", 6), ("Jupiter", 6),
]
