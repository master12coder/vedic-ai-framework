"""Namakarana scoring — name numerology, scoring, and suggestion logic.

Split from namakarana.py for the 300-line rule.
Handles: Chaldean numerology, name scoring against birth chart,
name suggestion generation, and the top-level compute_namakarana entry point.
...
from daivai_engine.compute.namakarana_tables import _CHALDEAN
